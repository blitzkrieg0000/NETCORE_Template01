...
public class Program {
    ...
    public static void Main(string[] args) {
        //! BUILDER----------------------------------------------------------------------------------------------------
        var builder = WebApplication.CreateBuilder(args); // ASP WEB SERVICE
        ...
        */
        ...
        /*
            GoogleAuthentication gibi kullanıcı doğrulama mekanizmaları OpenId kullanır.
            TODO Google ile giriş şuanlık askıya alındı. Google ile giriş daha sonra yapılacak.
        */
            options => {
                options.SaveTokens = true;
                options.CallbackPath = "/Auth/GoogleLoginAuth";
                options.Authority = builder.Configuration["Host:Domain"];
                ...
                //     tokens.Add(new AuthenticationToken() {
                //         Name = "id_token",
                //         Value = ctx.TokenEndpointResponse.IdToken,
                //     });
                //     tokens.Add(new AuthenticationToken() {
                //         Name = "refresh_token",
        ...
        #region Validator Settings
        /* 
            Controller'ların ModelBinding ile karşıladığı objelerin türüne göre otomatik validasyon sağlar.
            FluentValidation otomatik olarak bu özellikle Async çalışmadığından, middleware eklenerek sorun çözülmüştür.
            Bu yüzden bu özellik kapatıldı.
        */
        ...
        #region SeriLogger Settings
        Logger log = new LoggerConfiguration()
        .WriteTo.Console()
        // .WriteTo.File("logs/log.txt")
        .WriteTo.PostgreSQL(builder.Configuration.GetConnectionString("Default"), "logs",
        ...
        //Http isteklerinin loglanması için gereklidir.
        ...
        builder.Services.AddInfrastructureServices(builder.Configuration, multiplexer);
        ...
        // Logging
        app.UseSerilogRequestLogging(); //Loglanmasını istediğiniz middlewarelerden öncesine konulması gerekir.
        ...
        app.Use(async (context, next) => {
            string? username;
            if (context.User?.Identity?.IsAuthenticated != null || true) {
        ...
        app.UseEndpoints(endpoints => {
            ...
            // endpoints.MapHub<MasterHub>("/MasterHub"); //* SignalR
