...
public static class ServiceRegistration {
    ...
    public static void AddInfrastructureServices(this IServiceCollection service, IConfiguration configuration, IConnectionMultiplexer multiplexer) {
        ...
        service.AddScoped<ITwilioSMSService, TwilioSMSService>();
